...
function getSymbols() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('https://api.binance.com/api/v3/exchangeInfo')];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    return [4 /*yield*/, data.symbols.filter(function (symbol) { return /[A-Z]+BTC/.test(symbol.symbol) && symbol.status === 'TRADING'; })];
                case 3:
                    filteredSymbols = _a.sent();
                    btcSymbols = filteredSymbols.map(function (pair) { return pair.symbol; });
                    return [2 /*return*/, btcSymbols];
            }
        });
    });
}
